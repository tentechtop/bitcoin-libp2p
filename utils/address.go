...
func DecodeAddress(addr string, defaultNet *core.Params) (Address, error) {
	...
	if oneIndex > 1 {
		...
		if core.IsBech32SegwitPrefix(prefix) {
...
// bytes.
func NewAddressPubKeyHash(pkHash []byte, net *core.Params) (*AddressPubKeyHash, error) {
...
func (a *AddressPubKeyHash) IsForNet(net *core.Params) bool {
...
func NewAddressScriptHash(serializedScript []byte, net *core.Params) (*AddressScriptHash, error) {
...
// must be 20 bytes.
func NewAddressScriptHashFromHash(scriptHash []byte, net *core.Params) (*AddressScriptHash, error) {
	return newAddressScriptHashFromHash(scriptHash, net.ScriptHashAddrID)
}
...
// with the passed bitcoin network.
func (a *AddressScriptHash) IsForNet(net *core.Params) bool {
...
func NewAddressPubKey(serializedPubKey []byte, net *core.Params) (*AddressPubKey, error) {
...
// with the passed bitcoin network.
func (a *AddressPubKey) IsForNet(net *core.Params) bool {
...
//
// NOTE: This method is part of the Address interface.
func (a *AddressSegWit) IsForNet(net *core.Params) bool {
...
func NewAddressWitnessPubKeyHash(witnessProg []byte,
	net *core.Params) (*AddressWitnessPubKeyHash, error) {
...
func NewAddressWitnessScriptHash(witnessProg []byte,
	net *core.Params) (*AddressWitnessScriptHash, error) {
...
func NewAddressTaproot(witnessProg []byte,
	net *core.Params) (*AddressTaproot, error) {
