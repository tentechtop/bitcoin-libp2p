...
func (s PkScript) Address(chainParams *core.Params) (utils.Address, error) {
...
func ComputePkScript(sigScript []byte, witness core.TxWitness) (PkScript, error) {
	switch {
...
func computeWitnessPkScript(witness core.TxWitness) (PkScript, error) {
