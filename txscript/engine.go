...
// witness as input.
func (vm *Engine) verifyWitnessProgram(witness core.TxWitness) error {
	switch {
...
func NewEngine(scriptPubKey []byte, tx *core.MsgTx, txIdx int, flags ScriptFlags,
...
func NewDebugEngine(scriptPubKey []byte, tx *core.MsgTx, txIdx int,
