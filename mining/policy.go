...
func calcInputValueAge(tx *core.MsgTx, utxoView *blockchain.UtxoViewpoint, nextBlockHeight int32) float64 {
...
func CalcPriority(tx *core.MsgTx, utxoView *blockchain.UtxoViewpoint, nextBlockHeight int32) float64 {
